...
%% 90 deg:
% ./emss2fits.py ../TU3e20_centre_h_1440_@label.pat -y --labels a,b,c,d,e,h --ampl -r 900 -R .1 TU3e20_hy_90deg.fits 
% ./emss2fits.py ../K7s_centre_h_1440_@label.pat -y --labels a,b,c,d,e,h --ampl -r 900 -R .1 K7s_hy_90deg.fits 
%% 20 deg:
%./emss2fits.py ../TU3e20_centre_h_1440_@label.pat -y --labels a,b,c,d,e,h --ampl -r 1000 -R .02 TU3e20_hy_20deg.fits
%./emss2fits.py ../K7s_centre_h_1440_@label.pat -y --labels a,b,c,d,e,h --ampl -r 1000 -R .02 K7s_hy_20deg.fits
%% tigger settings: MIRP colormap, 4 log cycles, .0001 to .1 limits
