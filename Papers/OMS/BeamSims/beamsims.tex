...
%plot-cc.py horizon-masked/MeerKAT64*natural* --simulation-cutoff 0.5 -t - --x0 1 --x0 2 --x1 90 -o costcurve-main-asymptotic --deconvolution-cutoff 5e-7 -p upper_right --linear-y --y-format .1f --y-scale 1e+6 -y 'SCN contribution from $r>\theta_0$, $\mu\mathrm{Jy}$'
\end{figure}
