...
these techniques decrease as either the frequency of the reflector size is
...
form the feed position) -- as shown in Fig.~\ref{TU3e20:optics} -- to reduce the
...
\caption{\label{TU3e20:optics}The default offset Gregorian dish viewed from 
  $\theta=70^\circ$ (the angle from the optical axis which is parallel to the 
  $z$-axis in the figure) and  $\phi=70^\circ$ ($20^\circ$ from full side-on).
...
\begin{figure*}
  ...
  \caption{\label{fig:pb180}Normalised primary beam amplitude (in dB) for
    ...
    direction opposite the main beam. The top left picture is for prime focus,
    the top right for the default offset Gregorian; the bottom left for the
    shaped offset Gregorian and the bottom right for the offset Gregorian
...
\begin{figure*}
  ...
  \caption{\label{fig:pb18}Primary beam amplitude (dB scale) for the main beam
    region of the patterns shown in Fig.~\ref{fig:pb180}.  The top left picture
    is for prime focus, the top right for the default offset Gregorian; the
    bottom left for the shaped offset Gregorian and the bottom right for the
