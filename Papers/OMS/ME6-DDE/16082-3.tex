...
and none of the off-axis artifacts that plague regular selfcal. The differential gain solutions show a high signal-to-noise 
ratio, and may be used to extract information on DDEs and errors in the sky model.
}%
%optional conclusions
{The differential gain approach can eliminate DDE-related artifacts, and provide information for iterative improvements of sky models. 
